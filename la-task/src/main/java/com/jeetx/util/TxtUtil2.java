...
public class TxtUtil2 {
    ...
    public static void readFileByBytes(String fileName) {
        ...
        try {
            ...
            TxtUtil2.showAvailableBytes(in);
    ...
    public static void readFileByLines(String fileName) {
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
            	...
            	if(StringUtils.isNotBlank(bm) && StringUtils.isNotBlank(dm) && StringUtils.isNotBlank(lb)) {
            		//System.out.println("num " + num + ": " + bm + "-" + dm + "-" + lb);
                	StringBuffer sb = new StringBuffer();
                	sb.append("INSERT INTO test (bm,lb,dm) VALUES ('").append(bm).append("','").append(dm).append("','").append(lb).append("');");
                	System.out.println(sb);
                    //TxtUtil.appendMethodA("D:/456.txt", sb.toString());
                    //TxtUtil.appendMethodA("D:/456.txt", "\n");
                	bm = null;
                	dm = null;
                	lb = null;
            		num ++;
...
//    	}
        ...
        String fileName = "D:/居民点-1032.txt";
...
//        //显示文件内容
        TxtUtil2.readFileByLines(fileName);
