...
public class DesUtil {
    ...
    public static void main(String[] args) {
        String key = "22222222222";
        String data = "{\"username\":\"test2\",\"reqtime\":\"2015-08-01 11:26:54\"}";
        String str = DesUtil.encrypt(data, key);
        System.out.println(str);
        String dec = DesUtil.decrypt(str, key);
    ...
    public static String encrypt(String data, String key) {
    	return new DesUtil().strEnc(data, key, null, null);
    }
    ...
    public static String decrypt(String data, String key) {
    	return new DesUtil().strDec(data, key, null, null);
    }
    /**
     * DES加密/解密
     * 
