...
public class TxtUtil3 {
    ...
    public static void readFileByBytes(String fileName) {
        ...
        try {
            ...
            TxtUtil3.showAvailableBytes(in);
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
            	if(StringUtils.isNotBlank(tempString)) {
                	...
                	String head_img = "/upload/faces/".concat(num+".").concat("jpg");
                	sb.append("INSERT INTO tb_lottery_robotplant (head_img,nick_name,points_level_id,points) VALUES ('").append(head_img).append("','").append(tempString).append("',1,0);");
    ...
    public static void main(String[] args) throws IOException {
        ...
        TxtUtil3.readFileByLines(fileName);
    }
