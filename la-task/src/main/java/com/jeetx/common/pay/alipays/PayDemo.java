...
public class PayDemo {
	...
	public static String reqUrl = "http://www.661657.com/Pay_Index.html";
	public static String queryUrl = "http://www.661657.com/Pay_Trade_query.html";
	...
	public static void pay() {
		...
		if(resultJsonStr.contains("<!DOCTYPE html>")) {
	...
	public static void query() {
		String pay_orderid = "R20190420183930688884"; 
