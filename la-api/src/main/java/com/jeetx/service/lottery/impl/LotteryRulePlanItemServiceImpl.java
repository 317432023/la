...
//				try {
//					beignTime = DateTimeTool.dateFormat(dateFormat, DateTimeTool.addTime(DateTimeTool.dateFormat(dateFormat, beignTime), 3));
//					endTime = DateTimeTool.dateFormat(dateFormat, DateTimeTool.addTime(DateTimeTool.dateFormat(dateFormat, endTime), 3));
