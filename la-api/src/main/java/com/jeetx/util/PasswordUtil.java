...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String ciphertext = PasswordUtil.encrypt(str, password, PasswordUtil.getStaticSalt());
			System.out.println("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, PasswordUtil.getStaticSalt());
			System.out.println("明文:" + plaintext);
			
			String result = PasswordUtil.decrypt("ea3d519525358e00", "root", PasswordUtil.getStaticSalt());
